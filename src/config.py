...
class Settings(BaseSettings):
    ...
    ACCESS_TOKEN_EXPIRY: int = Field(default=3600, ge=300, le=86400, description="Access token expiry in seconds")
    REFRESH_TOKEN_EXPIRY: int = Field(default=2592000, ge=86400, le=2592000, description="Refresh token expiry in seconds")
